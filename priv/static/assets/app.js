...
`);
  ...
  hooks.store = {
    mounted() {
      this.handleEvent(
        "store",
        (item) => {
          localStorage.setItem("cart", item.data);
        }
      );
    }
  };
  hooks.restore = {
    mounted() {
      ...
      console.log(items);
      this.pushEvent("restore", { cart: items });
    }
  };
