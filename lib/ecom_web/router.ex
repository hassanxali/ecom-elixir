defmodule EcomWeb.Router do
  ...
  scope "/", EcomWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{EcomWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", EcomWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{EcomWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", EcomWeb do
    ...
    live_session :current_user,
      on_mount: [{EcomWeb.UserAuth, :mount_current_user}] do
