defmodule EcomWeb.OrderLiveTest do
  use EcomWeb.ConnCase

  import Phoenix.LiveViewTest
  import Ecom.OrdersFixtures

  @create_attrs %{user: 42, products: "some products", price: 42}
  ...
  describe "Index" do
    ...
    test "updates order in listing", %{conn: conn, order: order} do
      ...
      assert html =~ "some updated products"
    end
